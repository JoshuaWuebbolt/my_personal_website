...
const MakingWebsites = props => (
    ...
    <div className="content-area">
        <article>
            ...
            <p>As a personal aside, I&#39;m super excited to work for Wish. The money is really nice, and I&#39;ve also heard some good things about the work you do as a Wish intern. I&#39;ll be paired with a mentor for the duration of my internship, and I was told from my interviewer that they let you do some good work, but they don&#39;t overwhelm you with things to do.  Also, I&#39;m legitimately hella excited to blow $50 a month on Wish, you best believe I&#39;m gonna buy some <em>weird</em> stuff. And, lowkey, the thing i&#39;m the the most hyped for is the health stipend. $75 a month is gonna be very helpful in achieving my <a href="https://www.ethanlam.ca/blog/new-year-resolutions-2022">goal of getting fit in 2022</a>.</p>
            ...
            <p>Personally, I like using <a href="https://www.levels.fyi/internships/">levels.fyi</a> to view salaries. Online estimators aren&#39;t always the <em>most</em> accurate, but I&#39;ve found levels.fyi to be more accurate than other websites like Glassdoor. Let&#39;s look at some intern salaries:</p>
            ...
            <p>If you&#39;re struggling with finding projects to add to your resume, I CANNOT reccomend hackathons enough. Grab some friends, <a href="https://mlh.io">find some hackathons that seem cool</a>, drink a few gallons of caffeine, and crank something out to put on your resume. </p>
            ...
            <p><strong>What I Did Well</strong></p>
            <ul>
            <li>Engaged with the community way more. Met a lot of people that would help me out greatly in the future, and it&#39;s just <em>nice</em> to make friends! (this is the part where I plug the <a href="https://discord.gg/wfJUZyXjfM">MCSS discord server</a>, go join it if you&#39;re not in it)</li>
            ...
            <p>First, I did another hackathon and made <a href="https://devpost.com/software/lectern-hezyqc">Lectern</a>, another project to go on the resume. We didn&#39;t win, but it was still a great time AND I worked with some new tech I had never worked with before. W.</p>
            ...
            <p>I was director of marketing, and while I had never done any bona fide marketing before, I loved making cool things and sharing them with people (<a href="https://www.instagram.com/p/CVTI3JcDoNO/">this one&#39;s</a> my favorite). Also, getting involved in the community is super rewarding. Before the semester even started, we had already done a few events, and it felt  awesome to be part of a team doing cool things for students at the school!</p>
           ...
           <p>Looking back, I probably wouldn&#39;t have do this again. I&#39;ve almost never heard of anyone losing an offer from negotiating, generally the worst thing they&#39;ll say is <em>no</em>. But, the extra <em>$2</em> an hour really didn&#39;t amount to much over 4 months. Plus, I really was in no position to negotiate anything, considering I had <em>no</em> experience at the time AND I didn&#39;t even have a <em>phone call</em> from any other company. I won&#39;t lie, this was mostly an ego-driven decision.</p>
            ...
            <li>Once you&#39;re comfortable with those data structures, jump straight into solving questions with them. One way is just diving into Leetcode.com and doing whichever problems seem interesting, but if you want a curated list of problems, try the <a href="https://leetcode.com/discuss/general-discussion/460599/blind-75-leetcode-questions">blind 75</a>. <strong>You don&#39;t need to solve all of these to pass an interview</strong>, but try out some of the easier ones to start. If you make your way through this entire list (I haven&#39;t), you&#39;ll probably be able to ace almost any leetcode question an interviewer can throw at you.</li>
            <li>If you have an interview with a specific company, join the <a href="https://cscareers.dev/discord">cscareers discord</a>. They have a bot that can show you questions that specific companies are more likely to ask. </li>
            <li>Finally, there&#39;s also the holy grail: <a href="https://www.amazon.ca/Cracking-Coding-Interview-Programming-Questions/dp/0984782850">Cracking the Coding Interview</a>. I have not read this thoroughly (I&#39;ve skimmed it), but it&#39;s regarded as pretty much <em>the</em> book to get you past a coding interview.</li>
            </ul>
