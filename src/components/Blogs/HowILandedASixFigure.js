...
const MakingWebsites = props => (
    ...
    <div className="content-area">
        <article>
            ...
            <li>Not joining more communities/spending more time on my mental health. This isn&#39;t supposed to be a super deep blog post so I&#39;ll keep it light, but if you ever feel as though you&#39;re taking on too much, take a break. You&#39;ll be more productive, happier, and overall <em>better</em> afterwards. </li>
