...
const MakingWebsites = props => (
    ...
    <div className="content-area">
        <article>
            ...
            <p>Okay to preface this, this one might come off as a little braggy. I mean, it&#39;s hard to talk about this and <em>not</em> sound like you&#39;re bragging, but I promise the purpose of this blog is not (just) to brag.</p>
            ...
            <li>Not joining more communities/spending more time on my mental health. This isn&#39;t supposed to be a super deep blog post so I&#39;lll keep it light, but if you ever feel as though you&#39;re taking on too much, take a break. You&#39;ll be more productive, happier, and overall <em>better</em> afterwards. </li>
           ...
           <p>Looking back, I probably wouldn&#39;t have done this again. I&#39;ve almost never heard of anyone losing an offer from negotiating, generally the worst thing they&#39;ll say is <em>no</em>. But, the extra <em>$2</em> an hour really didn&#39;t amount to much over 4 months. Plus, I really was in no position to negotiate anything, considering I had <em>no</em> experience at the time AND I didn&#39;t even have a <em>phone call</em> from any other company. I won&#39;t lie, this was mostly an ego-driven decision.</p>
            ...
            <p>The internship itself went great; I got lucky and joined a team right as they were starting up a new project, and so I actually got to help architect their solution; something I&#39;ve been told you very rarely get the chance to do as an intern. I learned a lot about working with code on a massive scale, dealing with loads of data, and introducing redundancy to processes to ensure resiliency. (I also learned that working with Scala is very difficult, because there are 0 tutorials online on how to do <em>anything</em> with Scala).</p>
            ...
            <p>If you don&#39;t know what a system design question is, it&#39;s as the name implies: they&#39;ll describe an app to you, and you have to describe (on a high level) how you would architect the app — the tools you would use, how they would communicate with each other, etc. The system design question was definitely new — I think most internships won&#39;t ask you anything system design-esque, but if they do and you&#39;re stuck, try to at least demonstrate that you have a knowledge of the tools you would use to answer the question. I fumbled a bit on this question, but the interviewer was nice about it and nudged me in the right direction. Generally, I wouldn&#39;t stress too much about prepping for system design questions if you&#39;re looking for internships, your time will probably be better spent learning tech tools and practicing leetcode.</p>
