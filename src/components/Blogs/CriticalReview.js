...
const CriticalReview = props => (
    <div className="blog-page">
        ...
        <article>
            ...
            <p>In this blog post, I’ll be summarizing Aline Lerner’s article, <a href="http://blog.interviewing.io/technical-interview-performance-is-kind-of-arbitrary-heres-the-data/">Technical interview performance is kind of arbitrary</a>, and analyzing what I liked and disliked about the methodology used to reach their conclusions.</p>
            <h2 id="summary">Summary</h2>
            <p>In Lerner’s article, she states that single interview outcomes are not reliable when it comes to determining an applicant’s quality. She and her team used <a href="https://interviewing.io/">interviewing.io</a>, a platform for anonymous practice interviews, to conduct 299 interviews with 67 candidates. After each interview, Lerner's team rated candidates on a scale from one to four on various desirable qualities. Then, they took a weighted average of all the qualities to assign a score to the candidate. Finally, they ensured that every candidate was interviewed by multiple interviewers. They found that the performance of a candidate from interviewer to interviewer varied greatly. In fact, some candidates scored a perfect score of 4/4 with one interviewer, but didn’t even pass the threshold for “good” with another interviewer. Because of their findings, Lerner concluded that a single interview is not adequate for accurately assessing a candidate’s worth.</p>
            <h2 id="what-i-liked">What I Liked</h2>
            <p>Nothing in particular about their methodology stuck out as <em>amazing</em>, but the researchers did do many little things right. The sample size was large enough to draw valid conclusions from their data. Also, using interviewing.io, a website where people practice interviews, would ensure that anyone doing the interview would be trying to hone their interviewing skills and therefore would take the interviews seriously. In addition, they used experienced interviewers who had previously conducted interviews for large companies. This eliminated any possible discrepancies between the people conducting interviews in the experiment and the people who would be conducting interviews in real life. Finally, the analysis of the data is thorough. To further illustrate the point that they’re trying to make, they calculate the odds that a participant with a given score would fail an interview. They did this by rounding up all participants with the same Technical Scores into groups and resampling their data <em>10,000</em> times to ensure consistency. Overall, the researchers did a great job at covering their bases with their methods.</p>
